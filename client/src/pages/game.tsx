          ...
          <div className="space-y-4">
            <div className="space-y-3">
              <Input
                ...
                maxLength={20}
                className="w-full px-4 py-3 bg-white/20 border-2 border-habbo-purple text-white placeholder:text-white/70 focus:border-habbo-pink"
            ...
            <DialogContent className="bg-white/10 backdrop-blur-md border-4 border-habbo-green">
              ...
              <div className="space-y-4">
                <Input
                  ...
                  maxLength={10}
                  className="w-full px-4 py-3 bg-white/20 border-2 border-habbo-green text-white placeholder:text-white/70 focus:border-habbo-pink"
                />
